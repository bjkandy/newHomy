...
public class CommentServiceImpl implements CommentService {
	...
	public Page getPageList(Page page,Map map) {
		...
		if(totalCount >0){
		  ...
		  if(res.get("producttype").equals("20")&&res.get("proimg")!=null)
		  {
	//	  if(res.get("proimg")==null){
		  ...
		  }else if(res.get("producttype").equals("20")&&res.get("proimg")==null){
			  res.put("name","<div style=\"color: #FF9900\">"+res.get("name")+"</div>"+"<br>"+"<div style=\"color: #666\">"+res.get("color")+";"+res.get("size")+";"+"是否配照片输出:配照片输出"+"</div>");			    
		  }else{
		  res.put("name","<div style=\"color: #FF9900\">"+res.get("name")+"</div>"+"<br>"+"<div style=\"color: #666\">"+res.get("color")+";"+res.get("size")+"</div>");			  
		  }
	//	  }
	...
	public List<Map<String, Object>> getAllCommentTag() {
		// TODO Auto-generated method stub
		return commentMapper.getAllCommentTag();
	}

	@Override
	public List<Map<String, Object>> getByCommentTagByStarLevel(int starLevel) {
		// TODO Auto-generated method stub
		return commentMapper.getByCommentTagByStarLevel(starLevel);
	}

	@Override
	public int updateCommenttag(Map map) {
		return commentMapper.updateCommenttag(map);
	}

	@Override
	public int saveCommenttag(Map map) {
		// TODO Auto-generated method stub
		return commentMapper.saveCommenttag(map);
	}

	@Override
	public int deleteCommentTag(int id) {
		// TODO Auto-generated method stub
		return commentMapper.deleteCommentTag(id);
	}
}
