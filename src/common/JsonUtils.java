...
//		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);   
	...
	/**
	 * 转换为通用的List<Map<String, Object>>
	 * 
	 * @param jsonString
	 * @return
	 */
	public static List<Map<String, Object>> fromJsonToListbMap(String jsonString) {
		JavaType javaType = contructCollectionType(List.class, Map.class);
		return fromJson(jsonString, javaType);
	}
	...
	public static List<Map<String, Object>> fromJsonToListMap(String jsonString) {
		JavaType javaType = contructCollectionType(List.class, String.class);
		return fromJson(jsonString, javaType);
	}
	/**
	 * 转换为通用的List<String>
