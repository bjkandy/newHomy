								...
								<c:forEach items="${specvalueList}" var="specvalue">
									<tr>
		                                ...
		                                <td>
		                                    <label>
		                                        <select id="size" name="size">
		                                        	<option value="5寸" <c:if test="${specvalue.size eq '5寸'}">selected</c:if> >3*5</option>
		                                            ...
		                                            <option value="10寸" <c:if test="${specvalue.size eq '10寸'}">selected</c:if> >8*10</option>
		                                            <option value="12寸" <c:if test="${specvalue.size eq '12寸'}">selected</c:if> >10*12</option>
		                                            <option value="16寸" <c:if test="${specvalue.size eq '16寸'}">selected</c:if> >12*16</option>
													<option value="16寸" <c:if test="${specvalue.size eq '16寸'}">selected</c:if> >16*12</option>
		                                            <option value="20寸" <c:if test="${specvalue.size eq '20寸'}">selected</c:if> >16*20</option>
													<option value="20寸" <c:if test="${specvalue.size eq '20寸'}">selected</c:if> >20*15</option>
													<option value="24寸" <c:if test="${specvalue.size eq '24寸'}">selected</c:if> >24*18</option>
		                                        </select>
		                                    </label>
		                                </td>
		                                <td>
		                                ...
		                                <td>
		                                    <div class="input-prepend">
		                                        <span class="add-on">¥</span>
		                                        <input class="span2" placeholder=".00" style="width: 100px;" step="0.01" id="packageprice" name="packageprice" value="${specvalue.packageprice}" onkeyup="clearNoNum(this)">
		                                    </div>
		                                </td>
		                                <td>
		                                    <div class="input-prepend">
		                                ...
		                                <td class="thumbnail-block">
		                                    ...
		                                    <div class="operate" style="position: relative">
		                                    	<button type="button" class="btn btn-small preview" data-url="${imageViewDir}${specvalue.original}">预览</button>
		                                    	<button type="button"  class="btn btn-small replace">替换</button>
		                                ...
		                                <td class="original-block">
		                                    ...
		                                    <div class="operate" style="position: relative">
		                                    	<button  type="button" class="btn btn-small preview" data-url="${imageViewDir}${specvalue.thumbnail}">预览</button>
		                                    	<button  type="button" class="btn btn-small replace">替换</button>
...
<script src="hanson/js/hanson.xkfb_eidt.js"></script>

<div>
<input type="button" onclick="saveEditProduct()" value="保存">
</div>
</body>
</html>
