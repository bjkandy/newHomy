	...
	<body>
		...
		<div id="essentialInformation">
			...
			<div class="part2">
				...
				<div><b>*</b><span>拍摄类型:</span><input type="text" id="" name="" placeholder="请输入商品品牌"></div>
				<div><b>*</b><span>尺寸:</span><input type="text" id="" name="" placeholder="请输入商品尺寸"></div>
				<div><b>*</b><span>风格:</span><input type="text" id="" name="" placeholder="请输入商品风格"></div>
